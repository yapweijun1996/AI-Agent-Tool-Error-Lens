...
| Fixture corpus baseline | Pass | `node scripts/check-fixtures.mjs` validates 22 cases across 6 required families; assertions are consumed by parser tests |
...
| Full fixture result schema | Pass | Temporary Ajv draft-2020-12 validation accepts all 22 materialized corpus results |
...
| Resource/capability/package audit | Pass | 26 Node tests cover fixed/secondary bounds, structured-record safety, Unicode code-point bounds, and Vitest multi-failure attribution; static core capability audit and 70-file package allowlist audit pass |
